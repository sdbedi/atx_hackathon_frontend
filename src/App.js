    ...
    return (
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="8u 12u(narrow)">
                <div className="row">
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic01.jpg" alt="" /></a></div>
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic02.jpg" alt="" /></a></div>
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic03.jpg" alt="" /></a></div>
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic04.jpg" alt="" /></a></div>
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic05.jpg" alt="" /></a></div>
                  <div className="6u"><a href="#" className="image fit"><img src="images/pic06.jpg" alt="" /></a></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="third" className="main">
        ...
        <div className="content dark style3">
          <div className="container">
            <span className="image featured"><img src="images/pic07.jpg" alt="" /></span>
            <div className="row">
              <div className="4u 12u(narrow)">
